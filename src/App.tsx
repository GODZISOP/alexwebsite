  ...
  <div style={{ background: 'var(--bg-base)' }}>
    ...
    <section className="section-padding" style={{ backgroundColor: '#000', color: '#D4AF37', minHeight: '80vh', display: 'flex', alignItems: 'center' }}>
      <div className="container">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '3rem' }}>
          <div>
            <p style={{ color: 'white', fontWeight: 800, textTransform: 'uppercase', fontSize: '0.8rem', marginBottom: '1rem' }}>Nutrition</p>
            <p style={{ fontSize: '0.95rem', color: 'rgba(255,255,255,0.6)' }}>Tailored dietary strategies that fuel your performance without sacrificing the foods you love.</p>
          </div>
          <div>
            <p style={{ color: 'white', fontWeight: 800, textTransform: 'uppercase', fontSize: '0.8rem', marginBottom: '1rem' }}>Training</p>
            <p style={{ fontSize: '0.95rem', color: 'rgba(255,255,255,0.6)' }}>Evidence-based programming designed to build lean muscle and shred body fat effectively.</p>
          </div>
          <div>
            <p style={{ color: 'white', fontWeight: 800, textTransform: 'uppercase', fontSize: '0.8rem', marginBottom: '1rem' }}>Mindset</p>
            <p style={{ fontSize: '0.95rem', color: 'rgba(255,255,255,0.6)' }}>Cultivating the discipline and mental fortitude required for sustainable long-term health.</p>
          </div>
        </div>
      </div>
    </section>
      ...
      <div className="container">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '4rem' }}>
          <div>
            ...
            <p style={{ fontSize: '1rem', color: 'rgba(0,0,0,0.7)' }}>We analyze your current lifestyle, set realistic goals, and build a custom blueprint.</p>
          </div>
          <div>
            <p style={{ color: 'var(--primary)', fontWeight: 800, textTransform: 'uppercase', fontSize: '0.8rem', marginBottom: '1rem' }}>02 — Execute</p>
            <p style={{ fontSize: '1rem', color: 'rgba(0,0,0,0.7)' }}>Follow the specialized training and nutrition protocols designed specifically for your body type.</p>
          </div>
          <div>
            <p style={{ color: 'var(--primary)', fontWeight: 800, textTransform: 'uppercase', fontSize: '0.8rem', marginBottom: '1rem' }}>03 — Evolve</p>
            <p style={{ fontSize: '1rem', color: 'rgba(0,0,0,0.7)' }}>Track your progress, adjust as needed, and achieve the ultimate physical transformation.</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <div className="container">
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem' }}>
        {[
          ...
          <div key={i} className="service-card" style={{ padding: '3rem 2.5rem', background: 'white', border: '1px solid var(--border-light)', borderRadius: 'var(--radius-md)', height: '100%' }}>
